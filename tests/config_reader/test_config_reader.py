...
def test_config_reader_sections(test_config_reader):
    ...
    assert len(config_section_0) == 3, "Expected 3 parameters in test-section-0 from test config file."
    assert config_section_0["param_0"] == "value_0", "Expected param_0 to be 'value_0' in test-section-0 from test config file."
    assert config_section_0["param_1"] == "value_1", "Expected param_1 to be 'value_1' in test-section-0 from test config file."
    assert config_section_0["param_2"] == "value_2.0,value_2.1", "Expected param_2 to be 'value_2.0,value_2.1' in test-section-0 from test config file."

    config_section_1 = test_config_reader("test-section-1")
    assert len(config_section_1) == 4, "Expected 4 parameters in test-section-1 from test config file."
    assert config_section_1["param_0"] == "value_0", "Expected param_0 to be 'value_0' in test-section-1 from test config file."
    assert config_section_1["param_1"] == "value_1", "Expected param_1 to be 'value_1' in test-section-1 from test config file."
    assert config_section_1["param_2"] == "value_2", "Expected param_2 to be 'value_2' in test-section-1 from test config file."
    assert config_section_1["param_3"] == "value_3", "Expected param_3 to be 'value_3' in test-section-1 from test config file."
